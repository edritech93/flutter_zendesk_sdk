...
import 'package:flutter_zendesk_sdk/enum_message.dart';
import 'package:flutter_zendesk_sdk/observer_message.dart';
import 'package:flutter_zendesk_sdk/response_login.dart';

class FlutterZendeskSdk {
  static const MethodChannel _channel = MethodChannel('flutter_zendesk_sdk');
  ...
  static Future<void> initialize({
    ...
    if (androidChannelKey.isEmpty || iosChannelKey.isEmpty) {
      debugPrint('FlutterZendeskSdk - initialize - keys can not be empty');
      return;
    }
    ...
    try {
      ...
      debugPrint('FlutterZendeskSdk - initialize - Error: $e}');
      return;
    }
  }

  /// Invalidates the current instance of FlutterZendeskSdk.
  /// After calling this method you will have to call FlutterZendeskSdk.initialize again if you would like to use FlutterZendeskSdk.
  static Future<void> invalidate() async {
    try {
      await _channel.invokeMethod('invalidate');
    } catch (e) {
      debugPrint('FlutterZendeskSdk - invalidate - Error: $e}');
    }
  }
  ...
  static Future<void> show() async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - show - Error: $e}');
    }
  }
  ...
  static Future<void> clearConversationTags() async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - clearConversationTags - Error: $e}');
    }
  }
  ...
  static Future<void> loginUserCallbacks({
    ...
    if (jwt.isEmpty) {
      debugPrint('FlutterZendeskSdk - loginUser - jwt can not be empty');
      return;
    }
    ...
    try {
      ...
      debugPrint('FlutterZendeskSdk - loginUser - Error: $e}');
    }
  }
  ...
  static Future<void> logoutUserCallbacks({
    ...
    try {
      ...
      debugPrint('FlutterZendeskSdk - logoutUser - Error: $e}');
    }
  }
  ...
  static Future<void> listenUnreadMessages({
    ...
    try {
      ...
      debugPrint('FlutterZendeskSdk - listenUnreadMessages - Error: $e}');
    }
  }
  ...
  static Future<int> getUnreadMessageCount() async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - count - Error: $e}');
      return 0;
    }
  }
  ...
  static Future<bool> isInitialized() async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - isInitialized - Error: $e}');
      return false;
    }
  }
  ...
  static Future<bool> isLoggedIn() async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - isLoggedIn - Error: $e}');
      return false;
    }
  }
  ...
  static Future<void> setConversationFields(Map<String, String> fields) async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - setConversationFields - Error: $e}');
    }
  }
  ...
  static Future<void> clearConversationFields() async {
    try {
      ...
      debugPrint('FlutterZendeskSdk - clearConversationFields - Error: $e}');
    }
  }
}
